...
\section{Desarrollo}
	...
	\end{ttfamily}
	\\\\
	En caso de recibir un parámetro diferente a alguno de los listados anteriormente, o no recibir ninguno,  
	se muestra mensaje para el ingreso de la opción -h, para despejar posibles dudas de uso.\\
	Los nombres de los archivos ingresados van siempre luego de los argumentos. Dependiendo de los parámetros ingresados, la impresión se realiza respetando el siguiente orden: lineas, palabras y caracteres.
...
\section{ Diagrama de stack de la funciones MIPS}
	...
	\begin{figure}[!htp]
			...
			\end{center}
			\caption{Stack Frame de la función COUNT programada en MIPS} \label{Stack frame - Count}
	\end{figure}
	\newpage
	\begin{figure}[!htp]
				\begin{center}
